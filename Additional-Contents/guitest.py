...
# Widget and Layout -----
mainWin = App(title="Test App", height=720, width=1280)

leftSec = Box(mainWin, height=720, width=500, align="left")
rightSec = Box(mainWin, height=720, width=780, align="right")
leftSec.bg = "blue"
rightSec.bg = "green"
...
listbox = Box(leftSec, height=500, width=300)
listbox.bg = "red"
...
right1.bg = "grey"
imgbox = Box(rightSec, height=400, width=600)
imgbox.bg = "yellow"
altimg = Text(imgbox, text="PICTURE\nHERE", size=90)

spacer = Box(rightSec, height=280, width=99, align="left")
spacer.bg = "red"
bt1 = PushButton(rightSec, height=5, width=15, align="left")
