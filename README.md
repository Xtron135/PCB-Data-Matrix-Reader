...
```ShellSession
sudo mv /home/pi/PCB-Data-Matrix-Reader/Additional-Contents/* /home/pi/yolov5/
```
...
Data Matrix Dataset is originally from a Roboflow User, "tryclofus". All credits for the dataset goes to the dataset owner.\
